 ...
 */
class getCoverLetterRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CoverLetterRepository' shared autowired service.
     *
     * @return \App\Repository\CoverLetterRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CoverLetterRepository.php';

        return $container->privates['App\\Repository\\CoverLetterRepository'] = new \App\Repository\CoverLetterRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
